...
return [
    ...
    'dashboard' => [
        ...
        'government_initiatives' => 'Iniciativas Governamentais',
        'latest_votes' => 'Últimas Votações',
        'view_all' => 'Ver todas',
        'no_votes' => 'Sem votações registadas.',
        'unanimous_votes' => 'Votações Unânimes',
        'of_total' => 'do total',
        'most_active_party' => 'Partido Mais Ativo',
        'least_active_party' => 'Partido Menos Ativo',
        'initiatives_proposed' => 'iniciativas propostas',
        'highest_approval' => 'Maior Taxa de Aprovação',
        'opposition_vs_government' => 'Parlamento vs Governo',
        'government_short' => 'do Governo',
        'parliament_short' => 'do Parlamento',
        'party_overview' => 'Partidos — Visão Rápida',
    ],
    ...
    'footer' => [
        ...
        'attribution' => 'Fonte: Dados Abertos da Assembleia da República Portuguesa.',
        'rights' => 'Todos os direitos reservados.',
        'developed_by' => 'Desenvolvido por Cláudio Varandas',
    ],
    ...
    'parties' => [
        ...
        'voting_history' => 'Como votou este partido',
        'voting_history_empty' => 'Sem registos de votação.',
        'filter_all' => 'Todos',
        'date_pending' => 'Pendente',
        'sort_date' => 'Data',
        'sort_result' => 'Resultado',
        'show_voting_history' => 'Ver histórico de votação',
        'hide_voting_history' => 'Ocultar histórico de votação',
        'filter_type' => 'Tipo',
        'all_types' => 'Todos os tipos',
        'search_initiatives' => 'Pesquisar iniciativas...',
        'authored_initiatives' => 'Iniciativas de Autoria',
        'authored_empty' => 'Sem iniciativas de autoria registadas.',
        'show_authored' => 'Ver iniciativas de autoria',
        'hide_authored' => 'Ocultar iniciativas de autoria',
        'authored_search' => 'Pesquisar iniciativas...',
        'authored_all_types' => 'Todos os tipos',
        'authored_sort_date' => 'Data de Entrada',
        'authored_sort_status' => 'Estado',
        'authored_filter_all' => 'Todos',
        'authored_total' => 'Total',
        'authored_approved' => 'Aprovadas',
        'authored_rejected' => 'Rejeitadas',
        'authored_in_progress' => 'Em Discussão',
    ],
    ...
    'about' => [
        ...
        'data_source_body' => 'Todos os dados são obtidos a partir dos "Dados Abertos" que são registos oficiais e abertos da Assembleia da República Portuguesa. A informação é atualizada periodicamente para refletir as votações mais recentes. O VotoClaro não altera nem edita os dados — apresenta-os de forma organizada e acessível.',
    ...
    'days_average_unit' => 'dias em média',
];
